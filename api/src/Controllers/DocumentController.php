...
final class DocumentController
{
    ...
    public function create(Request $req, Response $res): Response
    {
        ...
        $doc_name = trim($body['name'] ?? $file->getClientFilename());
        $sidecarResponse = $this->callSidecar('storage/uploads/' . $storedName, $id, $doc_name);
 ...
 private function callSidecar(string $storagePath, int $docId, string $docName): ?array
{
